...
public class Test implements Serializable{
	...
	public Test(int id,Date date, int frequence, String signal) {
	...
	public Test(Date date, int frequence, String signal, String column) {
	...
	public String toString2() {
		return "Test [id=" + id + " date=" + date + " frequence=" + frequence + " signal = " + signal+ "]\n";
	}
}